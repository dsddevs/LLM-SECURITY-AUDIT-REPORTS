...
| Attack Technique: | Delimiter Confusion Attack                                                                |
...
> 🟫 **1. STRICT INPUT SANITIZATION WITH DELIMITERS**

- 🔴*Problem:* Model treats user delimiters (`---`, `###`) 
           as system boundaries.
- 🟢*Solution:* Escape or neutralize special characters 
		   in **USER INPUT** 
		   before processing.
```python
...
```
> 🟫 **2. IMMUTABLE SYSTEM PROMPT WITH ANCHORING**

- 🔴*Problem:* Model forgets original instructions 
           when seeing authority markers.
- 🟢*Solution:* Reinforce **SYSTEM PROMPT** with 
...
"""
```
> 🟫 **3. OUTPUT VALIDATION WITH WHITELIST**

- 🔴*Problem:* Model generates prohibited content despite filters.
- 🟢*Solution:* Validate output against expected format 
